"""Host-side wrapper for running Spark Silver processing inside Docker."""
...
SILVER_RUNNER = "/workspace/scripts/run_spark_silver.py"
...
def run_spark_silver(timeout: int = DEFAULT_TIMEOUT_SECONDS) -> CommandResult:
