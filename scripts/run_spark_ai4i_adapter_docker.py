"""Host-side wrapper for running the Spark AI4I feature adapter inside Docker."""
...
ADAPTER_RUNNER = "/workspace/scripts/run_spark_ai4i_adapter.py"
...
def run_spark_ai4i_adapter(timeout: int = DEFAULT_TIMEOUT_SECONDS) -> CommandResult:
