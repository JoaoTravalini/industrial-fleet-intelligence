"""Host-side wrapper for running Spark Gold processing inside Docker."""
...
GOLD_RUNNER = "/workspace/scripts/run_spark_gold.py"
...
def run_spark_gold(timeout: int = DEFAULT_TIMEOUT_SECONDS) -> CommandResult:
